...
//        self.view.addGestureRecognizer(tapGuester)
  ...
  @objc func handleSingleTap(sender : UITapGestureRecognizer){
    ...
    @IBAction func muteUnMuteEvent(_ sender: UIButton) {
        ...
        remoteRoom.recordEnabled = true
        remoteRoom.startRecord()
...
extension VCXConfrenceViewController : EnxRoomDelegate, EnxStreamDelegate {
    ...
    func roomRecord(on Data: [Any]?) {
        print("roomRecord: \(Data as Any)")
    }
    func roomRecordOff(_ Data: [Any]?) {
        print("roomRecordOff: \(Data as Any)")

    }
    func startRecordingEvent(_ response: [Any]?) {
        print("Start : \(response! as [Any])")

    }
    func stopRecordingEvent(_ response: [Any]?) {
        print("stop : \(response! as [Any])")
